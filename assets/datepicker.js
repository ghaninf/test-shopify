var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var CannotParseDateException = (function () {
        function CannotParseDateException() {
        }
        return CannotParseDateException;
    }());
    Tuecus_TheDatepicker.CannotParseDateException = CannotParseDateException;
    ...
    Tuecus_TheDatepicker.DateConverter_ = DateConverter_;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    ...
    var Datepicker = (function () {
        function Datepicker(input, container, options) {
            ...
            if (input !== null && !Tuecus_TheDatepicker.Helper_.isElement_(input)) {
                throw new Error('Input was expected to be null or an HTMLElement.');
            }
            if (container !== null && !Tuecus_TheDatepicker.Helper_.isElement_(container)) {
                throw new Error('Container was expected to be null or an HTMLElement.');
            }
            if (input === null && container === null) {
                throw new Error('At least one of input or container is mandatory.');
            }
            if (options !== null && !(options instanceof Tuecus_TheDatepicker.Options)) {
                throw new Error('Options was expected to be an instance of Options');
            }
            this.document_ = document;
            this.options = options !== null ? options.clone() : new Tuecus_TheDatepicker.Options();
            ...
            this.dateConverter_ = new Tuecus_TheDatepicker.DateConverter_(this.options);
            this.viewModel_ = new Tuecus_TheDatepicker.ViewModel_(this.options, this);
                ...
                case InitializationPhase.Untouched:
                  ...
                  //  this.createDeselectElement_();
                    ...
                    if (this.input !== null && this.options.isHiddenOnBlur()) {
                        ...
                        this.inputListenerRemover_ = Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.Focus, function (event) {
                            _this.open(event);
                        });
        ...
        Datepicker.prototype.selectDate = function (date, doUpdateMonth, event) {
            ...
            if (event === void 0) { event = null; }
            return this.viewModel_.selectDay_(event, Tuecus_TheDatepicker.Helper_.normalizeDate_('Date', date, this.options), !!doUpdateMonth);
        };
        ...
        Datepicker.prototype.goToMonth = function (month, event) {
            if (event === void 0) { event = null; }
            return this.viewModel_.goToMonth_(event, Tuecus_TheDatepicker.Helper_.normalizeDate_('Month', month, this.options));
        };
        ...
        Datepicker.prototype.readInput_ = function (event) {
            ...
            try {
                ...
                if (!(error instanceof Tuecus_TheDatepicker.CannotParseDateException)) {
                    throw error;
                }
                return false;
            }
        ...
        Datepicker.onDatepickerReady = function (element, callback) {
            ...
            if (!Tuecus_TheDatepicker.Helper_.isElement_(element)) {
                throw new Error('Element was expected to be an HTMLElement.');
            }
            callback = Tuecus_TheDatepicker.Helper_.checkFunction_('Callback', callback);
            var promise = null;
        ...
        Datepicker.prototype.createDeselectElement_ = function () {
            ...
            deselectButton.onclick = function (event) {
                ...
                Tuecus_TheDatepicker.Helper_.preventDefault_(event);
        ...
        Datepicker.prototype.initListeners_ = function () {
            ...
            if (!Datepicker.areGlobalListenersInitialized_) {
                ...
                Tuecus_TheDatepicker.Helper_.addEventListener_(this.document_, Tuecus_TheDatepicker.ListenerType_.MouseDown, checkMiss);
                Tuecus_TheDatepicker.Helper_.addEventListener_(this.document_, Tuecus_TheDatepicker.ListenerType_.FocusIn, checkMiss);
                Tuecus_TheDatepicker.Helper_.addEventListener_(this.document_, Tuecus_TheDatepicker.ListenerType_.KeyDown, function (event) {
            ...
            this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.container, Tuecus_TheDatepicker.ListenerType_.MouseDown, hit));
            this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.container, Tuecus_TheDatepicker.ListenerType_.FocusIn, hit));
            if (this.deselectElement_ !== null) {
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.deselectElement_, Tuecus_TheDatepicker.ListenerType_.MouseDown, hit));
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.deselectElement_, Tuecus_TheDatepicker.ListenerType_.FocusIn, hit));
            }
            if (this.input !== null) {
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.MouseDown, hit));
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.Focus, hit));
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.Blur, function () {
                    _this.updateInput_();
                }));
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.KeyDown, function (event) {
                    Tuecus_TheDatepicker.Helper_.stopPropagation_(event);
                }));
                this.listenerRemovers_.push(Tuecus_TheDatepicker.Helper_.addEventListener_(this.input, Tuecus_TheDatepicker.ListenerType_.KeyUp, function (event) {
    ...
    Tuecus_TheDatepicker.Datepicker = Datepicker;
    Tuecus_TheDatepicker.onDatepickerReady = Datepicker.onDatepickerReady;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var Day = (function () {
        function Day(date) {
            ...
            this.isWeekend = this.dayOfWeek === Tuecus_TheDatepicker.DayOfWeek.Saturday || this.dayOfWeek === Tuecus_TheDatepicker.DayOfWeek.Sunday;
        }
...
(function (Tuecus_TheDatepicker) {
    ...
    })(DayOfWeek = Tuecus_TheDatepicker.DayOfWeek || (Tuecus_TheDatepicker.DayOfWeek = {}));
    var Month;
    (function (Month) {
    ...
    })(Month = Tuecus_TheDatepicker.Month || (Tuecus_TheDatepicker.Month = {}));
    var KeyCode_;
    (function (KeyCode_) {
    ...
    })(KeyCode_ = Tuecus_TheDatepicker.KeyCode_ || (Tuecus_TheDatepicker.KeyCode_ = {}));
    var ListenerType_;
    ...
    })(ListenerType_ = Tuecus_TheDatepicker.ListenerType_ || (Tuecus_TheDatepicker.ListenerType_ = {}));
    var Helper_ = (function () {
        ...
        Helper_.normalizeDate_ = function (parameterName, value, options) {
            ...
            if (value instanceof Tuecus_TheDatepicker.Day) {
        ...
        Helper_.warnDeprecatedUsage_ = function (deprecatedMethod, alternateMethod) {
            ...
            window.console.warn('Tuecus_TheDatepicker: ' + deprecatedMethod + '() is deprecated, use ' + alternateMethod + '()');
    ...
    Tuecus_TheDatepicker.Helper_ = Helper_;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var HtmlHelper_ = (function () {
        ...
        HtmlHelper_.prototype.createAnchor_ = function (onClick) {
            ...
            anchor.onkeydown = function (event) {
                event = event || window.event;
                if (Tuecus_TheDatepicker.Helper_.inArray_([Tuecus_TheDatepicker.KeyCode_.Enter, Tuecus_TheDatepicker.KeyCode_.Space], event.keyCode)) {
                    Tuecus_TheDatepicker.Helper_.preventDefault_(event);
                    onClick(event);
                }
            };
    ...
    Tuecus_TheDatepicker.HtmlHelper_ = HtmlHelper_;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var EventType_;
    ...
    })(EventType_ = Tuecus_TheDatepicker.EventType_ || (Tuecus_TheDatepicker.EventType_ = {}));
    var AvailableDateNotFoundException = (function () {
        function AvailableDateNotFoundException() {
        }
        return AvailableDateNotFoundException;
    }());
    Tuecus_TheDatepicker.AvailableDateNotFoundException = AvailableDateNotFoundException;
    var Options = (function () {
        function Options(translator) {
            ...
            this.firstDayOfWeek_ = Tuecus_TheDatepicker.DayOfWeek.Monday;
            ...
            this.translator = translator !== null ? translator : new Tuecus_TheDatepicker.Translator();
            this.document_ = document;
        }
        ...
        Options.prototype.setMinDate = function (date) {
            var normalizedDate = Tuecus_TheDatepicker.Helper_.normalizeDate_('Min date', date, this);
        ...
        Options.prototype.setMaxDate = function (date) {
            var normalizedDate = Tuecus_TheDatepicker.Helper_.normalizeDate_('Max date', date, this);
        ...
        Options.prototype.setInitialMonth = function (month) {
            this.initialMonth_ = Tuecus_TheDatepicker.Helper_.normalizeDate_('Initial month', month, this);
        };
        Options.prototype.setInitialDate = function (value) {
            this.initialDate_ = Tuecus_TheDatepicker.Helper_.normalizeDate_('Initial date', value, this);
        };
        ...
        Options.prototype.setFirstDayOfWeek = function (dayOfWeek) {
            this.firstDayOfWeek_ = Tuecus_TheDatepicker.Helper_.checkNumber_('First day of week', dayOfWeek, 0, 6);
        };
        Options.prototype.setDateAvailabilityResolver = function (resolver) {
            this.dateAvailabilityResolver_ = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
        };
        Options.prototype.setCellContentResolver = function (resolver) {
            this.cellContentResolver_ = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
        };
        Options.prototype.setCellContentStructureResolver = function (init, update) {
            if (update === void 0) { update = null; }
            init = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver (init)', init);
            update = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver (update)', update);
        ...
        Options.prototype.setHeaderStructureResolver = function (resolver) {
            this.headerStructureResolver_ = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
        };
        Options.prototype.setFooterStructureResolver = function (resolver) {
            this.footerStructureResolver_ = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
        };
        Options.prototype.setCellClassesResolver = function (resolver) {
            Tuecus_TheDatepicker.Helper_.warnDeprecatedUsage_('setCellClassesResolver', 'addCellClassesResolver');
            this.cellClassesResolver_ = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
        };
        Options.prototype.addCellClassesResolver = function (resolver) {
            this.cellClassesResolvers_.push(Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver, false));
        };
        Options.prototype.removeCellClassesResolver = function (resolver) {
            if (resolver === void 0) { resolver = null; }
            resolver = Tuecus_TheDatepicker.Helper_.checkFunction_('Resolver', resolver);
            if (resolver === null) {
                this.cellClassesResolvers_ = [];
            }
            else {
        ...
        Options.prototype.addDayModifier = function (modifier) {
            this.dayModifiers_.push(Tuecus_TheDatepicker.Helper_.checkFunction_('Modifier', modifier, false));
        };
        Options.prototype.removeDayModifier = function (modifier) {
            if (modifier === void 0) { modifier = null; }
            modifier = Tuecus_TheDatepicker.Helper_.checkFunction_('Modifier', modifier);
            if (modifier === null) {
                this.dayModifiers_ = [];
            }
            else {
        ...
        Options.prototype.setInputFormat = function (format) {
            this.inputFormat_ = Tuecus_TheDatepicker.Helper_.checkString_('Input format', format, true);
        };
        ...
        Options.prototype.setClassesPrefix = function (prefix) {
            this.classesPrefix_ = Tuecus_TheDatepicker.Helper_.checkString_('Prefix', prefix);
        };
        Options.prototype.setShowCloseButton = function (value) {
            this.showCloseButton_ = !!value;
        };
        Options.prototype.setTitle = function (title) {
            this.title_ = Tuecus_TheDatepicker.Helper_.checkString_('Title', title);
        };
        Options.prototype.setDropdownItemsLimit = function (limit) {
            this.dropdownItemsLimit_ = Tuecus_TheDatepicker.Helper_.checkNumber_('Items limit', limit, 1);
        };
        ...
        Options.prototype.setGoBackHtml = function (html) {
            this.goBackHtml_ = Tuecus_TheDatepicker.Helper_.checkString_('Html', html);
        };
        Options.prototype.setGoForwardHtml = function (html) {
            this.goForwardHtml_ = Tuecus_TheDatepicker.Helper_.checkString_('Html', html);
        };
        Options.prototype.setCloseHtml = function (html) {
            this.closeHtml_ = Tuecus_TheDatepicker.Helper_.checkString_('Html', html);
        };
        Options.prototype.setResetHtml = function (html) {
            this.resetHtml_ = Tuecus_TheDatepicker.Helper_.checkString_('Html', html);
        };
        Options.prototype.setDeselectHtml = function (html) {
            this.deselectHtml_ = Tuecus_TheDatepicker.Helper_.checkString_('Html', html);
        };
        Options.prototype.setPositionFixing = function (value) {
            this.positionFixing_ = !!value;
        };
        Options.prototype.setToday = function (date) {
            this.today_ = Tuecus_TheDatepicker.Helper_.normalizeDate_('Today', date, this);
        };
        ...
        Options.prototype.getToday = function () {
            return this.today_ !== null ? new Date(this.today_.getTime()) : Tuecus_TheDatepicker.Helper_.resetTime_(new Date());
        };
        ...
        Options.prototype.onEvent_ = function (eventType, listener) {
            this.listeners_[eventType].push(Tuecus_TheDatepicker.Helper_.checkFunction_('Event listener', listener, false));
        };
        Options.prototype.offEvent_ = function (eventType, listener) {
            listener = Tuecus_TheDatepicker.Helper_.checkFunction_('Event listener', listener);
            if (listener === null) {
    ...
    Tuecus_TheDatepicker.Options = Options;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var Template_ = (function () {
        ...
        Template_.prototype.createBodyElement_ = function (viewModel) {
            ...
            if (this.options_.isMonthChangeOnSwipeEnabled_()) {
                Tuecus_TheDatepicker.Helper_.addSwipeListener_(body, function (event, isRightMove) {
        ...
        Template_.prototype.createResetElement_ = function (viewModel) {
            ...
            var title = this.options_.translator.translateTitle(Tuecus_TheDatepicker.TitleName.Reset);
            if (title !== '') {
        ...
        Template_.prototype.createCloseElement_ = function (viewModel) {
            ...
            var title = this.options_.translator.translateTitle(Tuecus_TheDatepicker.TitleName.Close);
            if (title !== '') {
        ...
        Template_.prototype.createGoElement_ = function (viewModel, directionForward) {
            ...
            var title = this.options_.translator.translateTitle(directionForward ? Tuecus_TheDatepicker.TitleName.GoForward : Tuecus_TheDatepicker.TitleName.GoBack);
            if (title !== '') {
        ...
        Template_.prototype.createTableHeaderCellElement_ = function (viewModel, dayOfWeek) {
            ...
            if (dayOfWeek === Tuecus_TheDatepicker.DayOfWeek.Saturday || dayOfWeek === Tuecus_TheDatepicker.DayOfWeek.Sunday) {
        ...
        Template_.prototype.slideMonth_ = function (viewModel, event, directionForward) {
            ...
            if (!this.options_.isMonthChangeAnimated() || !Tuecus_TheDatepicker.Helper_.isCssAnimationSupported_()) {
                change();
                return;
            }
            ...
            var animationIn = directionForward
                ? 'fade-in-right'
                : 'fade-in-left';
            var listenerRemover = Tuecus_TheDatepicker.Helper_.addEventListener_(this.bodyElement_, Tuecus_TheDatepicker.ListenerType_.AnimationEnd, function (event) {
                change();
                listenerRemover();
                ...
                listenerRemover = Tuecus_TheDatepicker.Helper_.addEventListener_(_this.bodyElement_, Tuecus_TheDatepicker.ListenerType_.AnimationEnd, function (event) {
                    listenerRemover();
                    _this.bodyElement_.className = _this.options_.prefixClass_('body');
                });
            });
    ...
    Tuecus_TheDatepicker.Template_ = Template_;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var TitleName;
    ...
    })(TitleName = Tuecus_TheDatepicker.TitleName || (Tuecus_TheDatepicker.TitleName = {}));
    var Translator = (function () {
        ...
        Translator.prototype.setDayOfWeekTranslation = function (dayOfWeek, translation) {
            this.dayOfWeekTranslations_[Tuecus_TheDatepicker.Helper_.checkNumber_('Day of week', dayOfWeek, 0, 6)] = Tuecus_TheDatepicker.Helper_.checkString_('Translation', translation);
        };
        Translator.prototype.setDayOfWeekFullTranslation = function (dayOfWeek, translation) {
            this.dayOfWeekFullTranslations_[Tuecus_TheDatepicker.Helper_.checkNumber_('Day of week', dayOfWeek, 0, 6)] = Tuecus_TheDatepicker.Helper_.checkString_('Translation', translation);
        };
        Translator.prototype.setMonthTranslation = function (month, translation) {
            this.monthTranslations_[Tuecus_TheDatepicker.Helper_.checkNumber_('Month', month, 0, 11)] = Tuecus_TheDatepicker.Helper_.checkString_('Translation', translation);
        };
        Translator.prototype.setMonthShortTranslation = function (month, translation) {
            this.monthShortTranslations_[Tuecus_TheDatepicker.Helper_.checkNumber_('Month', month, 0, 11)] = Tuecus_TheDatepicker.Helper_.checkString_('Translation', translation);
        };
        Translator.prototype.setTitleTranslation = function (titleName, translation) {
            this.titles_[titleName] = Tuecus_TheDatepicker.Helper_.checkString_('Translation', translation);
        };
    ...
    Tuecus_TheDatepicker.Translator = Translator;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
var Tuecus_TheDatepicker;
(function (Tuecus_TheDatepicker) {
    var MoveDirection_;
    ...
    })(MoveDirection_ = Tuecus_TheDatepicker.MoveDirection_ || (Tuecus_TheDatepicker.MoveDirection_ = {}));
    var ViewModel_ = (function () {
        function ViewModel_(options_, datepicker_) {
            ...
            this.active_ = false;
            this.template_ = new Tuecus_TheDatepicker.Template_(this.options_, new Tuecus_TheDatepicker.HtmlHelper_(this.options_), datepicker_.container, datepicker_.input !== null);
        }
        ...
        ViewModel_.prototype.canGoToMonth_ = function (month) {
            if (!Tuecus_TheDatepicker.Helper_.isValidDate_(month)) {
                return false;
            }
        ...
        ViewModel_.prototype.goToMonth_ = function (event, month, doCancelHighlight) {
            ...
            month = Tuecus_TheDatepicker.Helper_.resetTime_(new Date(month.getTime()));
            month.setDate(1);
        ...
        ViewModel_.prototype.selectDay_ = function (event, date, doUpdateMonth, doHighlight, canToggle) {
            ...
            var day;
            if (date instanceof Tuecus_TheDatepicker.Day) {
                day = date;
                date = day.getDate();
            }
            else {
        ...
        ViewModel_.prototype.selectPossibleDate_ = function () {
            try {
                ...
                if (!(error instanceof Tuecus_TheDatepicker.AvailableDateNotFoundException)) {
                    throw error;
                }
        ...
        ViewModel_.prototype.triggerKeyPress_ = function (event) {
            if (Tuecus_TheDatepicker.Helper_.inArray_([Tuecus_TheDatepicker.KeyCode_.Left, Tuecus_TheDatepicker.KeyCode_.Up, Tuecus_TheDatepicker.KeyCode_.Right, Tuecus_TheDatepicker.KeyCode_.Down], event.keyCode)) {
                Tuecus_TheDatepicker.Helper_.preventDefault_(event);
                if (this.highlightedDay_ !== null) {
        ...
        ViewModel_.prototype.triggerOnBeforeSelect_ = function (event, day, previousDay) {
            var _this = this;
            return this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.BeforeSelect, function (listener) {
        ...
        ViewModel_.prototype.triggerOnSelect_ = function (event, day, previousDay) {
            var _this = this;
            this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.Select, function (listener) {
                return listener.call(_this.datepicker_, event, day, previousDay);
            });
        };
        ViewModel_.prototype.triggerOnBeforeOpenAndClose_ = function (event, isOpening) {
            var _this = this;
            return this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.BeforeOpenAndClose, function (listener) {
        ...
        ViewModel_.prototype.triggerOnOpenAndClose_ = function (event, isOpening) {
            var _this = this;
            this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.OpenAndClose, function (listener) {
                return listener.call(_this.datepicker_, event, isOpening);
            });
        };
        ViewModel_.prototype.triggerOnBeforeMonthChange_ = function (event, month, previousMonth) {
            var _this = this;
            return this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.BeforeMonthChange, function (listener) {
        ...
        ViewModel_.prototype.triggerOnMonthChange_ = function (event, month, previousMonth) {
            var _this = this;
            this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.MonthChange, function (listener) {
                return listener.call(_this.datepicker_, event, month, previousMonth);
            });
        };
        ViewModel_.prototype.triggerOnBeforeFocus_ = function (event, day, previousDay) {
            var _this = this;
            return this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.BeforeFocus, function (listener) {
                return listener.call(_this.datepicker_, event, day, previousDay);
            });
        };
        ViewModel_.prototype.triggerOnFocus_ = function (event, day, previousDay) {
            var _this = this;
            this.options_.triggerEvent_(Tuecus_TheDatepicker.EventType_.Focus, function (listener) {
                return listener.call(_this.datepicker_, event, day, previousDay);
            });
        };
        ViewModel_.prototype.createDay_ = function (date) {
            date = Tuecus_TheDatepicker.Helper_.resetTime_(new Date(date.getTime()));
            var today = this.options_.getToday();
            var day = new Tuecus_TheDatepicker.Day(date);
        ...
        ViewModel_.prototype.translateKeyCodeToMoveDirection_ = function (key) {
            switch (key) {
                case Tuecus_TheDatepicker.KeyCode_.Left:
                    return MoveDirection_.Left;
                case Tuecus_TheDatepicker.KeyCode_.Up:
                    return MoveDirection_.Up;
                case Tuecus_TheDatepicker.KeyCode_.Right:
                    return MoveDirection_.Right;
                case Tuecus_TheDatepicker.KeyCode_.Down:
    ...
    Tuecus_TheDatepicker.ViewModel_ = ViewModel_;
})(Tuecus_TheDatepicker || (Tuecus_TheDatepicker = {}));
